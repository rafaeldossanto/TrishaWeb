...
class AppTheme {
  ...
  /// Wordmark da marca (AppBar do feed, barra do mapa e side nav).
  ///
  ...
  static ThemeData get dark {
    ...
    return base.copyWith(
      ...
      // Na web os bottom sheets nao devem esticar na janela inteira: viram uma
      // "folha" central estreita (no celular o teto nem chega a valer).
